...
func newCancunInstructionSet() JumpTable {
	...
	// Enable EOF v1
	instructionSet[EOFCREATE] = &operation{
		execute:     opEofCreate,
	...
	// Enable Aquarius (Data Accounts)
	instructionSet[DATACREATE] = &operation{
		execute:     opDataCreate,
		constantGas: Create2Gas,     // Reuse Create2 Cost
		dynamicGas:  gasCreate2,     // Reuse Create2 Memory calculation
		minStack:    minStack(5, 1), // val, off, len, salt, prog -> addr
		maxStack:    maxStack(5, 1),
		memorySize:  memoryCreate2, // checks offset/size
	}
	...
	instructionSet[RETURNCONTRACT] = &operation{
