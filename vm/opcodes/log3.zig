...
pub fn jit_compile(jit: anytype, pc: *usize, stack_top: *u64, bytecode: []const u8) !void {
    _ = pc;
    _ = bytecode;
    if (stack_top.* < 5) return error.StackUnderflow;
    ...
    try jit.emit_native_log3(offset_slot.register, size_slot.register, t0_slot.register, t1_slot.register, t2_slot.register);
    jit.pop_virtual(5);
    stack_top.* -= 5;
}
