...
type StateDB interface {
	...
	GetProgramAddress(common.Address) common.Address
	SetProgramAddress(common.Address, common.Address)
	...
	// Used for Auto-Sharding redirection in Aquarius.
	ResolveExecutionTarget(sender common.Address, to common.Address) (context common.Address, program common.Address, isRedirect bool)
}
