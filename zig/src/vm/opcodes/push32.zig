...
pub fn getImpl() struct { code: u8, impl: OpcodeImpl } {
    return .{
        .code = @intFromEnum(Opcode.PUSH32),
        .impl = OpcodeImpl{
            .execute = execute,
        },
    };
