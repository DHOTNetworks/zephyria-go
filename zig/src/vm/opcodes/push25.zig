...
pub fn getImpl() struct { code: u8, impl: OpcodeImpl } {
    return .{
        .code = @intFromEnum(Opcode.PUSH25),
        .impl = OpcodeImpl{
            .execute = execute,
        },
    };
