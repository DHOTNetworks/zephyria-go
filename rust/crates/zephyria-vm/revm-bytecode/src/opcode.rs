...
opcodes! {
    ...
    // 0xDE
    // 0xDF
    0xE0 => RJUMP          => stack_io(0, 0), immediate_size(2);
    ...
    0xE4 => RETF           => stack_io(0, 0);
    0xE5 => JUMPF          => stack_io(0, 0), immediate_size(2);
    ...
    // 0xED
    0xEE => RETURNCONTRACT => stack_io(3, 0), immediate_size(1);
    // 0xEF
    ...
    0xFC => REVERT_EOF      => stack_io(2, 0); // Wait, REVERT is already 0xFD.
