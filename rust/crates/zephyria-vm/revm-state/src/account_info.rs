...
use primitives::{Address, OnceLock, B256, KECCAK_EMPTY, U256};
...
pub struct AccountInfo {
    ...
    /// Zephyria: Program Address (Solana-style linking)
    pub program_address: Option<Address>,
}
...
impl PartialEq for AccountInfo {
    fn eq(&self, other: &Self) -> bool {
        self.balance == other.balance
            ...
            && self.program_address == other.program_address
    }
}
...
impl Hash for AccountInfo {
    fn hash<H: Hasher>(&self, state: &mut H) {
        ...
        self.program_address.hash(state);
    }
}
...
impl Ord for AccountInfo {
    fn cmp(&self, other: &Self) -> Ordering {
        self.balance
            ...
            .then_with(|| self.program_address.cmp(&other.program_address))
    }
}
...
impl AccountInfo {
    ...
    /// Zephyria: Sets the Program Address
    pub fn with_program_address(mut self, program_address: Address) -> Self {
