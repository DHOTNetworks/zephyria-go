...
pub enum InstructionResult {
    ...
    /// Return contract in not init EOF.
    ReturnContractInNotInitEOF,
    /// EOF aux data overflow.
    EofAuxDataOverflow,
    /// EOF aux data too small.
    EofAuxDataTooSmall,
    /// Return contract.
    ReturnContract,
}
...
impl<HaltReasonTr: From<HaltReason>> From<InstructionResult> for SuccessOrHalt<HaltReasonTr> {
    fn from(result: InstructionResult) -> Self {
        match result {
            InstructionResult::Continue => unreachable!("Continue is not a final result"),
            ...
            InstructionResult::InvalidEXTCALLTarget => Self::Revert,
            InstructionResult::EOFFunctionStackOverflow => {
                Self::Halt(HaltReason::StackOverflow.into())
            }
            InstructionResult::ReturnContractInNotInitEOF => Self::Revert,
            InstructionResult::EofAuxDataOverflow => Self::Halt(HaltReason::OutOfOffset.into()),
            InstructionResult::EofAuxDataTooSmall => Self::Halt(HaltReason::OutOfOffset.into()),
            InstructionResult::ReturnContract => Self::Success(SuccessReason::Return),
